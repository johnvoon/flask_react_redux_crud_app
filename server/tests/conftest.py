...
from server.blueprints.billing.models.credit_card import CreditCard
from server.blueprints.billing.models.coupon import Coupon
from server.blueprints.billing.models.subscription import Subscription
from server.blueprints.billing.gateways.stripecom import (
...
def session(db):
    ...
    Database must support SQL savepoints.

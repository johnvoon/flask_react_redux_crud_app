...
var menuToggle = function () {
  $('.menu-toggle i').click(function () {
    $('.practice-areas').addClass('open');
  });
  $('.fa-close').click(function () {
    $('.practice-areas').removeClass('open');
  });
};

var hoverEvents = function () {
  var $listItems = $(".practice-areas .navbar-nav > li");
  var $panels = $(".panel");
  $listItems.hover(
    function () {
      var index = $(this).index();
      $(this).addClass("selected")
      $($panels[index]).addClass("open");
    }, function () {
      var index = $(this).index();
      $(this).removeClass("selected")
      $($panels[index]).removeClass("open");
    }
  );
};

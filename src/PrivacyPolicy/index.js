      ...
      <div>
        <main>
          <Helmet
            ...
            meta={[
              { name: 'description', content: 'Privacy Policy of Concept Law Firm.'}
            ]}/>
          <div 
            className="jumbotron jumbotron-inverse">
            <div className="container text-center">
              <h1>Privacy Policy</h1>
              <h3>Our Firm's Privacy Policy was updated on 21 March 2017.</h3>
            </div>
          </div>
          <div className="privacy-content container-fluid">
            <p>
